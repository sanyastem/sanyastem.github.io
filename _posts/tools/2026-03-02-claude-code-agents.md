...
categories: tools
translation_of: "/en/tools/claude-code-agents/"
date: 2026-03-02
...
Кроме авто-запуска, можно описать собственного именованного субагента — файл `.claude/agents/<имя>.md` с frontmatter:
